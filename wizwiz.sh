...
git clone https://github.com/cli007/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
...
echo "Folder created successfully!"
 ...
 cd /var/www/html/
 wget -O wizwizpanel.zip https://github.com/cli007/wizwizxui-timebot/releases/download/10.1.9/wizwizpanel.zip
