...
$mainValues = [
    ...
    'increase_wallet_cart_to_cart'=>"لطفا یک اسکرین شات از رسید واریز ارسال کنید.🙏🏻

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

پس از تایید پرداخت، مبلغ واریز شده در حساب شما شارژ میشود. ✅",
    'order_increase_sent'=>"سفارش شما با موفقیت ثبت شد. 🎉🥳",
    'please_send_only_image'=>"لطفا فقط عکس ارسال کنید. در صورت هرگونه مشکل به پشتیبانی پیام دهید.",
    'reached_main_menu'=>"🔻خب برگشتیم
...
",
    ...
    'buy_account_cart_to_cart'=>"🟣 لطفا حتماااا از صفحه رسید پرداخت عکس بگیرید و داخل ربات ارسال کنید. 🟣

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

پس از تایید پرداخت مبلغ واریز شده، ساب لینک اشتراک خریداری شده از طریق ربات برای شما ارسال میشود.✅",
    'renew_ccount_cart_to_cart'=>"🟣 لطفا حتماااا از صفحه رسید پرداخت عکس بگیرید و داخل ربات ارسال کنید. 🟣

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME",
    'order_buy_sent'=>"🛍 سفارش شما با موفقیت ثبت شد.
پس از تایید صحت پرداخت ارسال خواهد شد ... 🥳",
...
",
    ...
    'select_one_to_show_detail'=> ' 🔅 سرویس مورد نظر را جهت مشاهده مشخصات کامل آن انتخاب کنید:',
    'you_dont_have_config'=>'شما هنوز هیچ اشتراک و سرویس فعالی ندارید. 🤷🏻',
...
",
    ...
    'start_message'=>'به ربات هوشمند vpcore خوش آمدید.🧡
جهت آموزش خرید و استفاده از ربات دکمه [آموزش استفاده 🎬] را کلیک کنید.👇🏻
🚪 /start',
    'new_member_joined'=>"📢 | عضو جدید :

نام و نام خانوادگی: FULLNAME
نام کاربری: @USERNAME
آیدی عددی: USERID

به نظرم یه پیام براش بفرست 😍",
    "not_joine_yet"=>"هنوز عضو کانال نیستی؟ 🤔",
    'insert_discount_code'=>"🎁🎉| کد تخفیف را وارد کنید:",
    "not_valid_discount_code"=>"این کد تخفیف معتبر نیست یا منقضی شده است 🥲🫠",
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
"send_config_uuid"=>"جهت دریافت مشخصات کامل اشتراک، لطفا لینک کانفیگ خریداری شده یا uuid آن را ارسال کنید.🕵🏻",
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'no_server_available'=>"سرور ها به سقف فروش رسیدند! لطفا بعدا مجدد امتحان کنید.",
    'buy_sub_select_location' => '🏴‍☠️ سرور مورد نظر را جهت تهیه اشتراک انتخاب کنید:',
    ...
    'buy_sub_select_category'=> "📆 مدت زمان اشتراک را انتخاب کنید:",
    'no_plan_available'=>"💡پلنی در این دسته بندی وجود ندارد",
    'receive_plans'=>"📍در حال دریافت لیست پلن ها",
    'buy_sub_select_plan'=> "🦄 حجم پلن مورد نیاز خود را انتخاب کنید:", 
    'buy_custom_plan'=>'➕ پلن دلخواه تو بساز',
    'select_one_plan_to_edit'=>"جهت ویرایش، یکی از پلن ها را انتخاب کنید.", 
    'enter_account_amount' => "♻️ تعداد اکانت درخواستی را وارد کنید حداکثر هربار 6 عدد:

⚠️ | نکته: در صورت وارد کردن به مقدار بالا احتمالا اکانت ساخته نشود و پنل x-ui دچار خطا شود.",
...
مدت زمان سرویس: DAYS روز',
    ...
    'pay_with_tron_wallet'=>"♻️ لطفا مبلغ AMOUNT ترون رو به والت زیر ارسال کنید و تکسید آیدی واریزی ترون را ارسال کنید :
...
$buttonValues = [
    ...
    'back_to_main'=>'برگشت به منوی قبل 🔙',
    ...
    'test_account'=>"🎁 سرویس تستی (رایگان)",
    'invite_friends'=>"⛓ زیر مجموعه ها",
    'my_info'=>"👤 پروفایل",
    ...
    'application_links'=>'آموزش استفاده 🎬',
    'my_tickets'=>"👩🏻‍💻 پشتیبانی آنلاین",
