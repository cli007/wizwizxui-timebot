...
جهت آموزش خرید و استفاده از ربات دکمه </b>آموزش 🎬<b> را کلیک کنید.👇🏻
🚪 /start',
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'buy_sub_select_location' => '🏴‍☠️ سرور مورد نظر جهت تهیه اشتراک را انتخاب کنید:',
