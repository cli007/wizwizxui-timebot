...
",
    ...
    'buy_account_cart_to_cart'=>"لطفا حتما یک اسکرین شات از رسید واریز ارسال کنید.🙏🏻

🔰 ACCOUNT-NUMBER
HOLDER-NAME

پس از تایید پرداخت مبلغ واریز شده، ساب لینک اشتراک از طریق ربات برای شما ارسال میشود.✅",
    'renew_ccount_cart_to_cart'=>"لطفا حتما یک اسکرین شات از رسید واریز ارسال کنید.🙏🏻
...
به نظرم یه پیام براش بفرست 😍",
    ...
    "not_valid_discount_code"=>"⚠️ این کد تخفیف معتبر نیست یا منقضی شده است.",
